  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto">
        <motion.h1 variants={itemVariants} className="text-6xl md:text-8xl font-playfair mb-12 tracking-tighter">
        ...
        <div className="grid md:grid-cols-2 gap-20">
          <motion.div variants={itemVariants} className="space-y-12">
            <div>
              <h3 className="font-satoshi font-bold text-sm uppercase tracking-widest text-stone-400 mb-4">General Inquiries</h3>
              <p className="text-2xl font-satoshi text-stone-800">hello@studentmentoring.com</p>
            </div>
            <div>
              <h3 className="font-satoshi font-bold text-sm uppercase tracking-widest text-stone-400 mb-4">Become a Tutor</h3>
          ...
          <motion.div variants={itemVariants}>
            <form name="contact" method="POST" data-netlify="true" className="space-y-8">
              ...
              <div className="flex flex-col gap-2">
                ...
                <select name="subject" className="bg-transparent border-b border-stone-300 py-3 focus:outline-none focus:border-black transition-colors font-satoshi">
