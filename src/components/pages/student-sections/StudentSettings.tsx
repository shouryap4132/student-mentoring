...
export default function StudentSettings({ profile, setProfile }: any) {
  ...
  const handleUpdate = async () => {
    ...
    if (error) {
      ...
      setProfile({...profile, full_name: name, bio: bio, knowledge_level: knowledge});
    ...
    <div className="max-w-3xl space-y-10">
      ...
      <div className="bg-white rounded-[2.5rem] border border-stone-200 p-8 shadow-sm">
        ...
        <div className="flex items-center gap-8">
          ...
          <div>
            <p className="text-sm text-stone-600 mb-4">Upload a profile picture to help other students connect with you.</p>
            <label className="inline-block px-6 py-3 bg-black text-white rounded-2xl font-bold text-xs uppercase tracking-widest cursor-pointer hover:bg-stone-900 transition-all disabled:opacity-50">
      ...
      <div className="bg-white rounded-[2.5rem] border border-stone-200 p-8 shadow-sm space-y-6">
        ...
        <div>
          ...
          <textarea 
            ...
            placeholder="Tell other students about yourself, your learning goals, and interests."
