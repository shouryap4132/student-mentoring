...
export default function VolunteerSettings({ profile, setProfile }: any) {
  ...
  const uploadAvatar = async (event: any) => {
    try {
      ...
      // 1. Get current session to ensure we have the right ID
      ...
      // Use userId in filename to prevent bucket clutter
      ...
      // 4. Update DB - Using userId directly from auth for security
      ...
      alert("Photo uploaded and saved to profile!");
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-2">
              <input 
                type="text"
                value={newSubject}
                placeholder="Add subject (e.g. SAT Math)"
